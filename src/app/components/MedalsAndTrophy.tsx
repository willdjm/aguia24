  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center w-full bg-blue-700 md:pb-20 pt-10">
        <div className="md:flex md:flex-row flex flex-col items-center gap-10 md:gap-0 md:justify-between w-full md:border md:border-white max-w-6xl md:rounded-full md:py-16 md:px-10">
        ...
        <div className="md:flex md:flex-row flex flex-col items-center justify-center w-full md:max-w-6xl py-10 md:py-20 md:px-10 px-4 gap-10">
          <picture>
        ...
        <div className="flex flex-col items-center justify-center w-full md:max-w-6xl md:px-10 px-4 py-10">
          <p className="text-white text-center font-normal">Somos especialistas em corrida de rua.</p>
          <p className="text-white text-center font-normal">Nossos treinadores irmão te preparar, entre em contato.</p>
          <a href="#" target="_blank" className="mt-10">
            <button className="bg-white text-blue-700 py-4 px-6 rounded-full font-medium">
              Acesse nosso site
            </button>
          </a>
        </div>
